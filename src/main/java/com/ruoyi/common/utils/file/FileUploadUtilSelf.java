 ...
 * @author ruoyi
 */
public class FileUploadUtilSelf
{
    /**
     * 默认大小 50M
     */
    ...
    {
        FileUploadUtilSelf.defaultBaseDir = defaultBaseDir;
    }
            ...
            InvalidExtensionException
    {
        ...
        if (fileNamelength > FileUploadUtilSelf.DEFAULT_FILE_NAME_LENGTH)
        {
            throw new FileNameLengthLimitExceededException(FileUploadUtilSelf.DEFAULT_FILE_NAME_LENGTH);
        }
