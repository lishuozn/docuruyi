 ...
 * @date 2019-11-16
 */
public class InventionVO extends BaseEntity
{
	...
	/** 第一发明人专业 */
	private Dept firstInventorMajor;
	/** 其他发明人 */
	...
	public Dept getFirstInventorMajor() {
		return firstInventorMajor;
	}

	public void setFirstInventorMajor(Dept firstInventorMajor) {
