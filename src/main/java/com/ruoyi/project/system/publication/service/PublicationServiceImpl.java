...
public class PublicationServiceImpl implements IPublicationService
{
    ...
    @Override
    public PublicationVO selectPublicatioVOById(Integer pbId) {
    	return publicationMapper.selectPublicatioVOById(pbId);
    }
    ...
    public List<PublicationVO> selectPublicationVOList(Publication publication) {
        return publicationMapper.selectPublicationVOList(publication);
    }
